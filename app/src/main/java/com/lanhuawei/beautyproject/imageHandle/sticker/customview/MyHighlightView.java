package com.lanhuawei.beautyproject.imageHandle.sticker.customview;
...
import com.lanhuawei.beautyproject.imageHandle.sticker.customview.drawable.EditableDrawable;
import com.lanhuawei.beautyproject.imageHandle.sticker.customview.drawable.FeatherDrawable;
import com.lanhuawei.beautyproject.imageHandle.sticker.util.Point2D;
import com.lanhuawei.beautyproject.imageHandle.sticker.util.UIUtils;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = MyApplication.getInstance().getResources().getDrawable(R.mipmap.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = MyApplication.getInstance().getResources().getDrawable(R.mipmap.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(DimensionUtil.dp2px(MyApplication.getInstance(),2));
