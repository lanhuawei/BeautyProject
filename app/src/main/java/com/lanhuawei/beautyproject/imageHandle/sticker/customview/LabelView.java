...
import com.lanhuawei.beautyproject.imageHandle.sticker.bean.TagItem;
...
public class LabelView extends LinearLayout {
    ...
    public LabelView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.sticker_view_label, this);
    ...
    public void draw(ViewGroup parent, final int left, final int top, boolean isLeft) {
        ...
        if (parentWidth <= 0) {
            parentWidth = PhoneMessage.ScreenWidth;
//            parentWidth = MyApplication.getApp().getScreenWidth();
        }
...
//            parentWidth = App.getApp().getScreenWidth();
    ...
    private int getImageWidth() {
        return imageWidth <= 0 ? PhoneMessage.ScreenWidth : imageWidth;
    }
